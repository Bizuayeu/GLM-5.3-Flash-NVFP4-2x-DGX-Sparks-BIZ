...
| 255,950-token input, one passphrase at the midpoint | 207.4 s, correct (2026-09-19, before the tie rule; 462.8 s on 1.5.0) |
| Maximum capacity, 262,080 input + 64 output tokens | 228.9 s, finite logprobs |
...
| [tenhkspark/glm53-flash-nvfp4-2node](https://github.com/tenhkspark/glm53-flash-nvfp4-2node) and the [Wabi checkpoint](https://huggingface.co/tenhkspark/GLM-5.3-Flash-NVFP4-Wabi) | Apache-2.0 (code), MIT (weights) | No code. Its W4A16 NVFP4 requantization of the BF16 attention projections was evaluated as P23 on fixtures and once on the full model and not adopted; the measurements are in the [optimization catalog](docs/optimization-catalog.md) |
