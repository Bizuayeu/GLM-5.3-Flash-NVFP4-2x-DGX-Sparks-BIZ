...
| Image input at 200K (vision), one active sequence | One synthetic image answered correctly, text/tool regressions passed, video rejected; large images and harness user interfaces not checked; [measurements and limits](docs/vision.md) |
