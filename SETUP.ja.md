...
> AGENTS.md、SETUP.ja.mdと参照先の運用・検証文書を読んでください。許可された2台の現状を変更前に調べ、前提がそろった工程を順に実行してください。既存作業・認証情報・重み・過去の証跡を保全し、非公開の作業レポートを更新してください。意図的な休止を尊重し、結果を実測してください。物理条件や記録すべき証拠が欠けて止まる場合は、阻害要因を記録して独立した準備を進めてください。実証なしに合格証跡を作成したり、デプロイ完了を宣言したりしないでください。
