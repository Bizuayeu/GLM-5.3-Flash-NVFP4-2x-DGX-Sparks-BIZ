...
| P17 TP=2 versus PP=2 | Implement/fixture-test intermediate tensors and mHC post/comb transport before matched A/B | Possible communication-wait savings versus stage serialization/imbalance | **Eight-layer PP1 control complete; PP2 validation in progress.** Four-layer stage splitting violated hybrid-cache requirements. Access recovered; both failed attempts stopped without OOM. Full-model A/B not run. [Evidence](component-validation.md#pipeline-fixture-preparation-and-startup-p17) |
