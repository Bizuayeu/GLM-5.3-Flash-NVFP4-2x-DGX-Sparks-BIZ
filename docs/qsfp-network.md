...
Do not reuse that size for a different MTU without checking. Raising MTU to 9000 is a separate change after confirming support along the path and arranging a change window. Ping does not measure line speed or RDMA throughput.
