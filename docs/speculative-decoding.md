...
- Compare depths by mean acceptance length, not by acceptance rate. A deeper k lowers the rate even when it yields more tokens per step; another recipe ranked k=5 and k=7 the wrong way round by rate (tonyd2wild PR #12, no license, no code adopted).
