        ...
        **kwargs,
        ...
        if is_kda_layer:
            ...
            self.self_attn = Glm5NextMLAAttention(
                ...
                # mla-quant-overlay: was quant_config=None ("MLA projections are BF16 in
...
class Glm5NextModel(nn.Module):
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        stacked_params_mapping = [
            ...
            # kda-quant-split-overlay (1.8.0): KDA q, k, v load into their own modules (no
            # mapping); b, f_a, g_a merge into in_proj_bfg_a. See kda.py.
